...
description = "Aguila Split keyboard"
'''Version 1.0'''
...
keyboard_definition = [
    ...
    [
     ...
     (8, None, '0'),
     ((4, 4), (1, 8), 'HID_KEYBOARD_SC_Y'),
     ((4, 4), (1, 9), 'HID_KEYBOARD_SC_U'),
     ((4, 4), (1, 10), 'HID_KEYBOARD_SC_I'),
     ((4, 4), (1, 11), 'HID_KEYBOARD_SC_O'),
     ((4, 4), (1, 12), 'HID_KEYBOARD_SC_P'),
     ((4, 4), (1, 13), 'HID_KEYBOARD_SC_OPENING_BRACKET_AND_OPENING_BRACE'),
     ((4, 4), (0, 13), 'HID_KEYBOARD_SC_CLOSING_BRACKET_AND_CLOSING_BRACE'),
    ],
    ...
    [
     ...
     (8, None, '0'),
     ((4, 4), (2, 8), 'HID_KEYBOARD_SC_H'),
     ((4, 4), (2, 9), 'HID_KEYBOARD_SC_J'),
     ((4, 4), (2, 10), 'HID_KEYBOARD_SC_K'),
     ((4, 4), (2, 11), 'HID_KEYBOARD_SC_L'),
     ((4, 4), (2, 12), 'HID_KEYBOARD_SC_SEMICOLON_AND_COLON'),
     ((4, 4), (2, 13), 'HID_KEYBOARD_SC_APOSTROPHE_AND_QUOTE'),
    ],
    ...
    [((9, 4), (3, 0), 'HID_KEYBOARD_SC_LEFT_SHIFT'),
     ...
     (8, None, '0'),
     ((4, 4), (3, 9), 'HID_KEYBOARD_SC_N'),
     ((4, 4), (3, 10), 'HID_KEYBOARD_SC_M'),
     ((4, 4), (3, 11), 'HID_KEYBOARD_SC_COMMA_AND_LESS_THAN_SIGN'),
     ((4, 4), (3, 12), 'HID_KEYBOARD_SC_DOT_AND_GREATER_THAN_SIGN'),
     ((4, 4), (3, 13), 'HID_KEYBOARD_SC_SLASH_AND_QUESTION_MARK'),
    ],
     # (4, None, '0'),
     # 2,
    ...
    [
     (24, None, '0'),
     ((4, 4), (2, 6), 'HID_KEYBOARD_SC_LEFT_ALT'),
     (8, None, '0'),
     ((4, 4), (2, 7), 'SCANCODE_FN2'),
    ],
    ...
    [
     ...
     ((4, -8), (1, 6), 'SCANCODE_FN'),
     ((4, -8), (1, 7), 'HID_KEYBOARD_SC_SPACE'),
     ((4, 4), (3, 7), 'HID_KEYBOARD_SC_BACKSLASH_AND_PIPE'),
     (18, None, '0'),
     ((4, 4), (3, 8), '0'),
    ],
]
